...
public class ViewListActivity extends AppCompatActivity {
    ...
    private Button mAwardListButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAwardListButton = (Button) findViewById(R.id.award_list_button);
        mAwardListButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

            }
        });
        mCreateListButton = (Button) findViewById(R.id.create_list_button);
